<div id="header" class="" style="height: 138px;">
                    <div class="inner">
                        <div class="top">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 clearfix">
                                        ...
                                        <a href="#" id="logo"><img class="img-responsive" src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Logo_TV_2015.png" alt=""></a>
                                  </div>
                                    <div class="col-md-9 col-sm-9">
                                        <div class="contacts_block">
                                            ...
                                            <div class="phone styler_color">
                                                <div></div>
                                                <div>HOTLINE : 0978 94 57 58 </div>
                                                <span>CÔNG TY CỔ PHẦN TRẦN NGUYỄN HÀ</span>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
