			...
			<div class="featured-listings">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<h2 class="block-title styler_color">Sản Phẩm Thiết Kế </h2>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #1 image -->
							<img class="img-responsive" src="img/body/house1.jpg" alt="">
							<!-- house #1 headline -->
							<div class="heading styler_bg_color">Sản phẩm 1</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$689,000</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<!-- link to house #1 featured item detail -->
											<div class="more">
												<a href="javascript:void(0)" class="styler_color property-link">Xem Chi Tiết</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #2 image -->
							<img class="img-responsive" src="img/body/house2.jpg" alt="">
							<!-- house #2 headline -->
							<div class="heading styler_bg_color">Sản Phẩm 2</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$535,000</div>
										</div>
										<div class="col-md-6 col-sm-6">
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #3 image -->
							<img class="img-responsive" src="img/body/house10.jpg" alt="">
							<!-- house #3 headline -->
							<div class="heading styler_bg_color">Sản Phẩm 3</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$819,000</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<!-- link to house #3 featured item detail -->
											<div class="more">
												<a id="item3" href="javascript:void(0)" class="styler_color property-link">Xem Chi Tiết</a>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #4 image -->
							<img class="img-responsive" src="img/body/house4.jpg" alt="">
							<!-- house #4 headline -->
							<div class="heading styler_bg_color">Sản phẩm 4</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$379,500</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<!-- link to house #4 featured item detail -->
											<div class="more">
												<a id="item4" href="javascript:void(0)" class="styler_color property-link">Xem Chi Tiết</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #5 image -->
							<img class="img-responsive" src="img/body/house7.jpg" alt="">
							<!-- house #5 headline -->
							<div class="heading styler_bg_color">Sản phẩm 5</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$450,000</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<!-- link to house #5 featured item detail -->
											<div class="more">
												<a id="item5" href="javascript:void(0)" class="styler_color property-link">Xem Chi Tiết</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-md-4 col-sm-4">
						...
						<div class="featured-item">
							<!-- house #6 image -->
							<img class="img-responsive" src="img/body/house9.jpg" alt="">
							<!-- house #6 headline -->
							<div class="heading styler_bg_color">Sản phẩm 6</div>
								...
								<div class="item-info">
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="price styler_color">$519,500</div>
										</div>
										<div class="col-md-6 col-sm-6">
											<!-- link to house #6 featured item detail -->
											<div class="more">
												<a id="item6" href="javascript:void(0)" class="styler_color property-link">Xem Chi Tiết</a>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="inner-block">
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							...
							<div class="address">
								<div class="address-top">8590 Highland Crest</div>
								<div class="address-bottom">Dallas, TX 75208</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							...
							<div class="details-info">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										...
										<div class="item-id">MLS #: 120876543</div>
									...
									<div class="active" id="details1">
										...
										<ul class="info_slides">
											<li class="active">
												...
												<div class="text" style="display: block;">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
														vulputate. Cras et enim at lacus hendrerit condimentum.
														Vivamus sed nisi luctus metus bibendum semper. Etiam at
														facilisis ipsum. Etiam rutrum mi eget sem suscipit
														pellentesque. Aenean lobortis commodo eros ut
														sollicitudin.</p>
													<div class="row">
														<div class="col-md-6 col-sm-6">
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #1 exterior slide text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
				...
				<div class="inner-block">
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							...
							<div class="address">
								<div class="address-top">6231 Topsfield Lane</div>
								<div class="address-bottom">Dallas, TX 75233</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
								...
								<div class="tab-content tabs_blocks">
									<div class="active" id="details2">
										...
										<ul class="info_slides">
											...
											<li class="active"><a href="#" class="styler_color"><i class="arr styler_color"></i>Details</a> <!-- edit featured listings house #2 property tab info slide #1 (details) summary text here -->
												<div class="text" style="display: block;">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #2 exterior slide text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<div class="address">
								...
								<div class="address-top">2311 Mira Vista</div>
								<div class="address-bottom">Dallas, TX 75251</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							...
							<div class="details-info">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										...
										<div class="item-id">MLS #: 120876549</div>
									...
									<div class="active" id="details3">
										...
										<ul class="info_slides">
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #3 exterior slide text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
				...
				<div class="inner-block">
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							...
							<div class="address">
								<div class="address-top">6800 Sherburne Drive</div>
								<div class="address-bottom">Dallas, TX 75243</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							<!-- edit featured property #4 price -->
							<div class="price styler_color">$879,500</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-8 col-sm-8">
									...
									<div class="active" id="details4">
										...
										<ul class="info_slides">
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #4 exterior slide text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<div class="address">
								...
								<div class="address-top">6830 Hilltop Lane</div>
								<div class="address-bottom">Dallas, TX 75280</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							...
							<div class="details-info">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										...
										<div class="item-id">MLS #: 120876765</div>
								...
								<div class="tab-content tabs_blocks">
									<div class="active" id="details5">
										...
										<ul class="info_slides">
											...
											<li class="active"><a href="#" class="styler_color"><i class="arr styler_color"></i>Details</a> <!-- edit featured listings house #5 property tab info slide #1 (details) summary text here -->
												<div class="text" style="display: block;">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #5 exterior slide text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<div class="address">
								...
								<div class="address-top">4433 Colfax Circle</div>
								<div class="address-bottom">Dallas, TX 75231</div>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							...
							<div class="details-info">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										...
										<div class="item-id">MLS #: 12087762</div>
									...
									<div class="active" id="details6">
										...
										<ul class="info_slides">
											...
											<li>
												...
												<a href="#" class="styler_color"><i class="arr styler_color"></i>Additional
													Details</a> <!-- edit featured listings house #6 additional details tab text summary here -->
												<div class="text">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
														Fusce bibendum neque quis congue bibendum. Suspendisse
														vitae velit diam. Nulla vestibulum interdum lectus in
